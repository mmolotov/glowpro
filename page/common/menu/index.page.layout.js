...
const CONTROLS = {
    ...
    flashlightButton(clickCallback) {
        return CONTROLS.button(0, BUTTONS.flashlightOn.normal_src, BUTTONS.flashlightOn.press_src, clickCallback)
    },
    flashlightText() {
        return CONTROLS.text(0, TRANSLATION_KEYS.flashlight)
    },
    blinkerButton(clickCallback) {
        return CONTROLS.button(1, BUTTONS.flashlightOn.normal_src, BUTTONS.flashlightOn.press_src, clickCallback)
    },
    blinkerText() {
        return CONTROLS.text(1, TRANSLATION_KEYS.blinker)
    },
    morseButton(clickCallback) {
        return CONTROLS.button(2, BUTTONS.flashlightOn.normal_src, BUTTONS.flashlightOn.press_src, clickCallback)
    },
    morseText() {
